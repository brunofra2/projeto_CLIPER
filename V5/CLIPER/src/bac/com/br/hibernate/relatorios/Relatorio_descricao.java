 ...
 * @author bruno
 */
public class Relatorio_descricao {

    public Relatorio_descricao(Long i,String s,String d,String imagem) {
        try {
            ...
            InputStream caminhorelatorio = getClass().getClassLoader().getResourceAsStream("bac/com/br/hibernate/relatorios/Descricao_cargo.jasper");
