 ...
 * @author bruno
 */
public class Cadastrar_decricao_cargo extends javax.swing.JDialog {
     ...
     */
    public Cadastrar_decricao_cargo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public Cadastrar_decricao_cargo(Carregar_descricoes parent, boolean modal) {
        super(parent, modal);
        this.pai = parent;
        initComponents();
        Utils.maximizar(this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cadastrar_decricao_cargo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Cadastrar_decricao_cargo dialog = new Cadastrar_decricao_cargo(new javax.swing.JFrame(), true);
