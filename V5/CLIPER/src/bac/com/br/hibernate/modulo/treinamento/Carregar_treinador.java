 ...
 * @author bruno
 */
public class Carregar_treinador extends javax.swing.JDialog {
    private Tela_principal pai;
    List<Treinador> lista;
    Treinador tre;
    /**
     * Creates new form Carregar_treinador
     */
    public Carregar_treinador(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    public Carregar_treinador(Tela_principal parent, boolean modal) {
        super(parent, modal);
        this.pai = parent;
        initComponents();
    ...
    protected void atualiza(String s){
        try {
            lista = new TreinadorDao().getlista(s);
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(txpesquisa, javax.swing.GroupLayout.DEFAULT_SIZE, 205, Short.MAX_VALUE)
        ...
        tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NOME", "FORMAÇÃO", "EMAIL", "SUPERVISOR", "EMAIL SUPERVISOR"
            }
        ) {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (row < 0) {
            ...
            if (Msg.confirmar(this,"Deseja realmente excluir este registro") == true) {
                try {
                    new TreinadorDao().excluir(lista.get(row));
                Loggin.arquivo_log("excluido cadastro de um treinador com o id"+lista.get(row));
                    atualiza("");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (row < 0) {
            ...
            Cadastrar_treinador t = new Cadastrar_treinador(this, true);
            t.setAlterar(true);
            t.preenche(lista.get(row));
            t.setVisible(true);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Carregar_treinador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Carregar_treinador dialog = new Carregar_treinador(new javax.swing.JFrame(), true);
