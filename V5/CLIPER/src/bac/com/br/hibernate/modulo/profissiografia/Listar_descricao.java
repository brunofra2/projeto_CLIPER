 ...
 * @author bruno
 */
public class Listar_descricao extends javax.swing.JDialog {
    private Tela_principal pai;
    List<Descricao> lista_descricao = new ArrayList<Descricao>();
    /**
     * Creates new form Carregar_descricoes
     */
    public Listar_descricao(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        descricoes();
        Utils.maximizar(this);
    }
    public Listar_descricao(Tela_principal parent, boolean modal) {
        super(parent, modal);
        this.pai = parent;
        initComponents();
        descricoes();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        new Inserir_decricao_cargo(this, true).setVisible(true);
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
            ...
            if(row < 0){
                ...
                Inserir_decricao_cargo cadastrar = new Inserir_decricao_cargo(this, true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Listar_descricao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Listar_descricao dialog = new Listar_descricao(new javax.swing.JFrame(), true);
