 ...
 * @author bruno
 */
public class Adicionar_historico extends javax.swing.JDialog {
     
    private Listar_colaborador pai;
    private Inserir_colaboradores irmao;
    Historico his;
    Colaborador col;
    Descricao des;
     ...
     */
    public Adicionar_historico(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        atualizacombo();
//        listar(col.getId());
        initComponents();
    ...
    public Adicionar_historico(Listar_colaborador parent, boolean modal) {
        super(parent, modal);
        this.pai = parent;
        initComponents();
        atualizacombo();
    ...
    public Adicionar_historico(Inserir_colaboradores parent, boolean modal) {
        super(parent, modal);
        this.irmao = parent;
        initComponents();
        atualizacombo();
    ...
    */
    ...
    private void initComponents() {
        ...
        data_inicio.setFont(new java.awt.Font("Times New Roman", 1, 10)); // NOI18N
        ...
        data_fim.setFont(new java.awt.Font("Times New Roman", 1, 10)); // NOI18N
        ...
        cbfuncao.setFont(new java.awt.Font("Times New Roman", 1, 10)); // NOI18N
        ...
        atividades.setFont(new java.awt.Font("Times New Roman", 1, 10)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Adicionar_historico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Adicionar_historico dialog = new Adicionar_historico(new javax.swing.JFrame(), true);
