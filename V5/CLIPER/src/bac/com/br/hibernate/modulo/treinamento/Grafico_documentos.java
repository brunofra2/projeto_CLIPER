 ...
 * @author bruno
 */
public class Grafico_documentos extends javax.swing.JDialog {
     ...
     */
    public Grafico_documentos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        grafico();
        //executar();
    ...
    public Grafico_documentos(Tela_principal parent, boolean modal) {
        super(parent, modal);
        this.pai =parent;
        initComponents();
        grafico();
    ...
    private void grafico() {
        try {
            ...
            lista_treinados = new DocumentoDao().grafico("2019");
            total = Double.valueOf(lista_documento.size());
            treinados = Double.valueOf(lista_treinados.size());
            resultado = total - treinados;
        } catch (Exception e) {
            e.printStackTrace();
            Msg.erro(this, "erro ao calcular grafico \n"+e.getMessage());
        }
    /*    try {
            lista_documento = new DocumentoDao().grafico();
    ...
    public void verifica_status(){
        ...
        for (int i = 0; i < add.size(); i++) {
            d = new DocumentoDao().estatus(add.get(i));
            if(d != null){
            lista_grafico.add(d);
            }else{
    ...
    private DefaultPieDataset createPieDataset() {
        ...
        try {
                    ...
                    dataset.setValue("DOCUMENTOS NAO TREINADOS", resultado);
                    dataset.setValue("DOCUMENTOS TREINADOS", treinados);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void listar_colaboradores(){
        try {
            lista_id = new DocumentoDao().colaboradores_nulos();
            lista_nome = new DocumentoDao().colaboradores_nulos2();
    ...
    */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Grafico_documentos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Grafico_documentos dialog = new Grafico_documentos(new javax.swing.JFrame(), true);
