 ...
 * @author Usuário
 */
public class Cadastrar_colaboradores extends javax.swing.JDialog {
     ...
     */
    public Cadastrar_colaboradores(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.iniciar();
    }

    public Cadastrar_colaboradores(Carregar_colaboradores parent, boolean modal) {
        super(parent, modal);
        this.pai = parent;
        initComponents();
        this.iniciar();
    ...
    public Cadastrar_colaboradores(Cadastrar_treinamento sobrinho, boolean modal) {
    ...
    */
                ...
                try {
                    ...
                    Msg.informacao(this, "salvo com sucesso");
                       if(Msg.confirmar(this, "deseja adicionar item ao histórico de cargos ?") == true){
                            Adicionar_periodos da = new Adicionar_periodos(this, true);
                            da.seleciona(col);
                         //   da.listar(col.getId());
                            da.setVisible(true);
                       }
    ...
    private void initComponents() {
        ...
        try {
            ctps.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("##.###")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
...
//inserir_alterar();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cadastrar_colaboradores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Cadastrar_colaboradores dialog = new Cadastrar_colaboradores(new javax.swing.JFrame(), true);
