 ...
 * @author Usuário
 */
public class Carregar_empresa extends javax.swing.JDialog {
    private Tela_principal pai;
    List<Empresa> lista;
    Empresa em;
    /**
     * Creates new form Carregar_empresa
     */
    public Carregar_empresa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    public Carregar_empresa(Tela_principal parent, boolean modal) {
        super(parent, modal);
        this.pai= parent;
        initComponents();
    ...
    protected void atualizar(String s){
        try {
            lista = new EmpresaDao().getlista(s);
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(txpesquisa, javax.swing.GroupLayout.DEFAULT_SIZE, 184, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Cadastrar_Empresa e = new Cadastrar_Empresa(this, true);
        e.setAlterar(false);
        e.setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(row < 0){
            ...
            if(Msg.confirmar(this, "Deseja realmente excluir este registro") == true){
                try {
                    new EmpresaDao().excluir(lista.get(row));
                Loggin.arquivo_log("excluido cadastro de uma empresa com o id"+lista.get(row));
                atualizar("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Carregar_empresa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Carregar_empresa dialog = new Carregar_empresa(new javax.swing.JFrame(), true);
