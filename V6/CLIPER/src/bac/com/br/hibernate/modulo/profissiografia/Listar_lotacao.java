 ...
 * @author bruno
 */
public class Listar_lotacao extends javax.swing.JDialog {
    private Tela_principalP pai;
    List<Lotacao> lista = new ArrayList<Lotacao>();
    /**
     * Creates new form Listar_lotacao
     */
    public Listar_lotacao(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        atualizar("");
        Utils.maximizar(this);
    }
    public Listar_lotacao(Tela_principalP parent, boolean modal) {
        super(parent, modal);
        this.pai = parent;
        initComponents();
        atualizar("");
    ...
    protected void atualizar(String texto){
        try {
            DefaultTableModel model = (DefaultTableModel) tabela_lotacao.getModel();
        lista = new LotacaoDao().getlista(texto);
        model.setNumRows(0);
        for (Lotacao lista1 : lista) {
    ...
    private void initComponents() {
        ...
        tabela_lotacao.setFont(new java.awt.Font("Times New Roman", 1, 10)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Listar_lotacao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Listar_lotacao dialog = new Listar_lotacao(new javax.swing.JFrame(), true);
