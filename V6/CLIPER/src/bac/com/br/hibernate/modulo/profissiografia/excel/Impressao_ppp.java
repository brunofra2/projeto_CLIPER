...
public class Impressao_ppp {
    ...
    private void criar_solicitacao(WritableSheet sheet, Colaborador c, WritableCellFormat negrito, WritableCellFormat normal) {
        try {
            ...
            Label texto21 = new Label(7, 13, c.getEstado(), normal);
        ...
        try {
            ...
            for (Historico his : c.getHistoricoList()) {
                ...
                if (his.getPeriodoFim() == null) {
                    ...
                    datas = new Label(0, ppp, form.format(his.getPeriodoInicio()) + " até " + "Presente data", normal);

                } else {

                    sheet.mergeCells(0, ppp, 1, ppp);
                    datas = new Label(0, ppp, form.format(his.getPeriodoInicio()) + " até " + form.format(his.getPeriodoFim()), normal);
...
//                }
    ...
    private Integer criar_lotacao(WritableSheet sheet, Colaborador c, Integer count, WritableCellFormat negrito, WritableCellFormat normal) {
        try {
            ...
            Label gfip = new Label(10, count + 1, "13.7 - código GFIP", normal);
            sheet.addCell(titulo);
            sheet.addCell(cnpj);
            ...
            for (Historico his : c.getHistoricoList()) {
                ...
                if (his.getPeriodoFim() == null) {
                    ...
                    datas = new Label(0, count, form.format(his.getPeriodoInicio()) + " até " + "Presente data", normal);
                } else {

                    sheet.mergeCells(0, count, 1, count);
                    datas = new Label(0, count, form.format(his.getPeriodoInicio()) + " até " + form.format(his.getPeriodoFim()), normal);
                }
        ...
        try {
            ...
            for (int i = 0; i <= c.getHistoricoList().size(); i++) {
                ...
                if (i == c.getHistoricoList().size()) {
                    texto10 = new Label(0, rod + 8, form.format(c.getHistoricoList().get(0).getPeriodoInicio()) + " até " + "Presente data", normal);
