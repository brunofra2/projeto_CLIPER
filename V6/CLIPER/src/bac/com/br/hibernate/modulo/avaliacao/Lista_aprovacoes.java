 ...
 * @author bruno
 */
public class Lista_aprovacoes extends javax.swing.JDialog {
     ...
     */
    public Lista_aprovacoes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        Utils.maximizar(this);
        atualizar();
    }
    public Lista_aprovacoes(Av_principal parent, boolean modal) {
        super(parent, modal);
        this.pai = parent;
        initComponents();
        Utils.maximizar(this);
     ...
     public void atualizar(){
        try {
            ...
            model.setNumRows(0);
            listaAV = new AvaliacaoDao().getlista("APROVACAO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Lista_aprovacoes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Lista_aprovacoes dialog = new Lista_aprovacoes(new javax.swing.JFrame(), true);
