 ...
 * @author bruno
 */
public class Relatorio_documentos {

    public Relatorio_documentos(Long i,String ano,String imagem) {
        try {
            System.out.println("\n" + i);
            ...
            InputStream caminhorelatorio = getClass().getClassLoader().getResourceAsStream("bac/com/br/hibernate/relatorios/Documentos_treinados.jasper");
