 ...
 * @author bruno
 */
public class Relatorio_execucao {

    public Relatorio_execucao(Long i,String imagem) {
        try {
            System.out.println("\n" + i);
            ...
            InputStream caminhorelatorio = getClass().getClassLoader().getResourceAsStream("bac/com/br/hibernate/relatorios/execucao.jasper");
