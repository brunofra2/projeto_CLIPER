 ...
 * @author bruno
 */
public class Colaboradores_treinados {

    public Colaboradores_treinados(Long i,String s,String imagem) {
        try {
            System.out.println("\n" + i);
            ...
            InputStream caminhorelatorio = getClass().getClassLoader().getResourceAsStream("bac/com/br/hibernate/relatorios/comparador.jasper");
