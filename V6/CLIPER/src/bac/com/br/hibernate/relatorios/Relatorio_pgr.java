 ...
 * @author bruno
 */
public class Relatorio_pgr {

    public Relatorio_pgr(Long i,String imagem) {
        try {
            System.out.println("\n" + i);
            ...
            InputStream caminhorelatorio = getClass().getClassLoader().getResourceAsStream("bac/com/br/hibernate/relatorios/Cronograma_pgr.jasper");
