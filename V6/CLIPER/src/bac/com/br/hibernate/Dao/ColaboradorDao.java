...
public class ColaboradorDao {
    ...
    public List idade(Avaliacao c) {
        em.getTransaction().begin();
        Query query = em.createNativeQuery("SELECT FLOOR(DATEDIFF(colaborador.data_nasc,CURDATE())/ 365.25) FROM colaborador \n" +
"WHERE colaborador.id =:id");
        query.setParameter("id",c.getIdColaborador());
